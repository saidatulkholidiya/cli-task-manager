...
const loadConfig = (file, output, baseConfigDir = null) => {
    ...
    if (!((_a = tsConfig.compilerOptions) === null || _a === void 0 ? void 0 : _a.rootDir)) {
        tsConfig.compilerOptions = Object.assign(Object.assign({}, ((_b = tsConfig.compilerOptions) !== null && _b !== void 0 ? _b : {})), { rootDir: '.' });
    }
    const baseTsConfig = mylas_1.Json.loadS(file, true);
    const { compilerOptions: { baseUrl, outDir, declarationDir, paths, rootDir } = {
        baseUrl: undefined,
        outDir: undefined,
    ...
    const config = {};
    if (outDir || ((_c = baseTsConfig === null || baseTsConfig === void 0 ? void 0 : baseTsConfig.compilerOptions) === null || _c === void 0 ? void 0 : _c.outDir)) {
        let replacedOutDir = outDir || ((_d = baseTsConfig === null || baseTsConfig === void 0 ? void 0 : baseTsConfig.compilerOptions) === null || _d === void 0 ? void 0 : _d.outDir);
    ...
    else if (config.paths !== undefined &&
        Object.keys(config.paths).length !== 0) {
        const resolvedRootDir = (0, path_1.resolve)(configDir, rootDir);
        for (const key in config.paths) {
            config.paths[key] = config.paths[key].map((path) => (0, path_1.relative)(resolvedRootDir, (0, path_1.resolve)(configDir, path)));
        }
    }
    if (declarationDir) {
    ...
    config.fileExtensions = (_e = tscAliasConfig === null || tscAliasConfig === void 0 ? void 0 : tscAliasConfig.fileExtensions) !== null && _e !== void 0 ? _e : {};
    const replacerFile = (_g = (_f = config.replacers) === null || _f === void 0 ? void 0 : _f.pathReplacer) === null || _g === void 0 ? void 0 : _g.file;
    if (replacerFile) {
